...
#         ws.append(["Title", "Amount", "Type", "Category", "Description", "Date"])
...
#             if exp.date and exp.date.strftime("%Y-%m") == current_month
#         ]
...
#         if not month_expenses:
#             print("NO MONTHLY DATA:", user.email)
#             continue
...
#                 clean_path = exp.image.replace("media\\", "").replace("media/", "")
#                 print("cleapath",clean_path)
#                 image_url = f"{BASE_URL}/media/{clean_path}"
#                 print("image_url",image_url)

#                 # SAFE IMAGE TAG (email compatible)
#                 img_tag = f'''
#                 <img src="{image_url}" width="80" height="80"
...
#         <p style="margin-top:20px;font-size:12px;color:gray;">
#         Auto Generated Monthly Expense Report
#         </p>
